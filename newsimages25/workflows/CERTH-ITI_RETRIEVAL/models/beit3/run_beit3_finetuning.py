...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='beit3_base_patch16_384', type=str, metavar='MODEL',
    ...
    parser.add_argument('--sentencepiece_model', type=str, default= '/home/dgalanop/PycharmProjects/AVS_2024/LW_Network/BEIT/unilm-master/beit3/beit3.spm',
