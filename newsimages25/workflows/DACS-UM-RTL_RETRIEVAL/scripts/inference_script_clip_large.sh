python -m src.retrieval_pipeline_inference \
   --faiss_index_path ./faiss/shards_250/openai/clip-vit-large-patch14/image_index.faiss \
   --image_paths_file ./faiss/shards_250/openai/clip-vit-large-patch14/image_paths.txt \
   --csv_path ./data/newsimages_v1.1/newsarticles.csv \
   --subset_split ./data/newsimages_v1.1/subset.csv \
   --model_family clip \
   --model_id openai/clip-vit-large-patch14 \
   --output_path ./results/inference/shards_250/identity/clip-vit-large-patch14 \
   --num_candidates 25;
...
python -m src.retrieval_pipeline_inference \
   ...
   --model_family clip \
   --model_id openai/clip-vit-large-patch14 \
   --output_path ./results/inference/shards_250/vlm_judge/clip-vit-large-patch14 \
   --num_candidates 25 \
...
python -m src.retrieval_pipeline_inference \
   ...
   --model_family clip \
   --model_id openai/clip-vit-large-patch14 \
   --output_path ./results/inference/shards_250/llm_rewriting/clip-vit-large-patch14 \
   --num_candidates 25 \
...
python -m src.retrieval_pipeline_inference \
   ...
   --model_family clip \
   --model_id openai/clip-vit-large-patch14 \
   --output_path ./results/inference/shards_250/aesthetics/clip-vit-large-patch14 \
   --num_candidates 25 \
